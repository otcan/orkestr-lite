...
The fixture screenshots demonstrate the tested product interface, not a live challenge-account run. ORK-373 supplies separate sanitized live GPT-5.6 evidence for the video and submission.
...
- sanitized live mission and model evidence from ORK-373;
